const express = require('express')//third party package, so we import it
const app = express()
const PORT = 4000
...
app.get('/products/:id', (req, res) => {
    ...
    const product = products.find((pd) => pd.id === id) //find is better than filter P.S. it returns the exact object, or its first occurrence
    res.send(product)
})
